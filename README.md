...
```
IDAI105-1000414-ADITYA-JITENDRA-KUMAR-SAHANI-SA/
...
## 📸 Visual Gallery & Dashboard Walkthrough

### 1. 🏠 Overview & EDA Analysis
Comprehensive visual analysis of the EV charging dataset, showing usage trends, charger distributions, and correlation matrices.

| ![EDA Analysis](Screenshots/EDA%20Analysis.png) | ![Feature Correlation](Screenshots/Feature%20Correlation%20Matrix.png) |
|:---:|:---:|
| *General EDA Overview* | *Feature Correlation Matrix* |

### 2. 🗺️ Interactive Geographic Mapping
Real-time geographic visualization of charging stations across the global network using Mapbox.

![Geo Map](Screenshots/Geo%20Map.png)

### 3. 🧠 Smart Clustering (K-Means)
Grouping stations into behavioral clusters based on usage patterns, capacity, and cost.

| ![Cluster Profiles](Screenshots/Cluster%20Profiles.png) | ![K-Means Analysis](Screenshots/K-Means%20Clustering%20Analysis.png) |
|:---:|:---:|
| *Detailed Cluster Profiles* | *Elbow Method & Clustering Logic* |

### 4. 🔗 Association Rule Mining
Uncovering hidden relationships between station features and user demand using the Apriori algorithm.

| ![Association Rules](Screenshots/Association%20Rule%20Mining%20—%20Apriori%20Algorithm.png) | ![Rules Interpretation](Screenshots/Top%20Rules%20Interpretation.png) |
|:---:|:---:|
| *Mining Frequent Itemsets* | *Strategic Rule Interpretation* |

### 5. 🚨 Anomaly Detection
Identifying outliers and anomalous station behaviors using Z-Score and IQR methods.

| ![Anomaly Detection](Screenshots/Anomaly%20Detection%20—%20Multi-Method%20Consensus.png) | ![Anomaly Analysis](Screenshots/Anomaly%20Detection%20—%20Multi-Method%20Consensus%20Part%202.png) |
|:---:|:---:|
| *Statistical Outlier Detection* | *Anomalous Station Deep-Dive* |

### 6. 💡 Strategic Insights & Recommendations
Data-driven business recommendations for infrastructure scaling and optimization.

![Strategic Recommendations](Screenshots/Strategic%20Recommendations.png)
...
```bash
# Clone repository
git clone https://github.com/adityasahani392217/IDAI105-1000414-ADITYA-JITENDRA-KUMAR-SAHANI-SA.git
cd IDAI105-1000414-ADITYA-JITENDRA-KUMAR-SAHANI-SA
...
| Candidate Registration Number | 1000414 |
| CRS Name | Artificial Intelligence |
| Course Name | Data Mining |
| School Name | Aspee Nutan Academy |
| GitHub Repository | `https://github.com/adityasahani392217/IDAI105-1000414-ADITYA-JITENDRA-KUMAR-SAHANI-SA` |
